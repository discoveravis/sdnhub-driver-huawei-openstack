...
import org.openo.sdnhub.osdriver.mockserver.OsdriverDriverSuccessServer;
...
public class ITHealthCheckSuccessTest extends TestManager {
    ...
    private OsdriverDriverSuccessServer acwanServer = new OsdriverDriverSuccessServer();
    ...
    public void test() throws ServiceException {
        File createFile = new File("src/integration-test/resources/testcase_jsons/healthcheck.json");
