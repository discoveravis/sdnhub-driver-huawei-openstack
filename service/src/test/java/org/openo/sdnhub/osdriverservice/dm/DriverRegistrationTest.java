...
package org.openo.sdnhub.osdriverservice.dm;
...
public class DriverRegistrationTest {
    ...
    DriverRegistration driverRegLstner = new DriverRegistration();
    ...
    @Test
    public void testContextInitialized_IOException() throws Exception {
    ...
    public void testContextInitialized_Success() throws Exception {
        ...
        s.writeObject(dmRegistrationBodyMap);
        s.close();
    ...
    @Test
    public void testContextInitialized_WithIP() throws Exception {
